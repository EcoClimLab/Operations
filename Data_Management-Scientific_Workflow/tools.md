...
## GitHub
- Create an account [here](https://github.com). It is useful to [request an education account](https://github.com/settings/education/benefits), with benefits including unlimited private repos. These will be useful if you end up adopting GitHub for work outside this lab. Your request may be more likely be successful if you use an .edu email account.
